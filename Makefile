...
DATA = pg_readonly--1.0.0.sql pg_readonly--1.0.4.sql pg_readonly--1.0.5.sql  pg_readonly--1.0.6.sql
...
pgxn:
	git archive --format zip  --output ../pgxn/pg_readonly/pg_readonly-1.0.6.zip master
